...
Процедура ПриЗаписиНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	//СклонениеПредставленийОбъектов.ПриЗаписиФормыОбъектаСклонения(ЭтотОбъект, Объект.Наименование,
	//	ТекущийОбъект.Ссылка, ПараметрыСклонения);
	//// Конец СтандартныеПодсистемы.СклонениеПредставленийОбъектов
...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	...
	Оповестить("Запись__Клиенты", Новый Структура, Объект.Ссылка);
...
Процедура НаименованиеПриИзменении(Элемент)
	...
	//Объект.Имя      = ФИО.Имя;
	//_ДемоЛокализацияКлиентСервер.ПриЗаполненииНациональныхПолейФизическогоЛица(Объект, ФИО);
